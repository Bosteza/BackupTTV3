    ...
    <SafeAreaView style={[styles.container, {paddingTop: topPadding}]}>
      ...
      <View
        ...
        <TouchableOpacity
          ...
          <Ionicons
            name="arrow-back"
            size={Math.max(18, Math.round(titleFont * 0.9))}
        ...
        <View style={styles.headerRight}>
          ...
          <Text
            style={[
              styles.username,
              {
                fontSize: clamp(bodyFont, 12, 18),
                marginRight: Math.round(Math.max(8, width * 0.02)),
                maxWidth: rightNameMaxWidth,
              },
            ]}
            numberOfLines={1}
            ellipsizeMode="tail">
        ...
        <View style={[styles.innerWrap, {width: contentMaxWidth}]}>
          ...
          <View style={styles.topHeading}>
            <Ionicons
              ...
              size={Math.max(18, Math.round(sectionTitleFont * 0.9))}
              color={styles.title.color}
            />
            <Text
              style={[
                styles.title,
                {fontSize: sectionTitleFont, marginLeft: 10},
              ]}
              numberOfLines={2}
              ellipsizeMode="tail">
          ...
          <View
            style={[styles.policyContainer, {marginTop: Math.round(rf(6))}]}>
            ...
            <View
              style={[
                ...
                {
                  paddingVertical: Math.round(rf(14)),
                  paddingHorizontal: Math.round(rf(14)),
                },
              ]}>
              <Text
                style={[
                  styles.intro,
                  {fontSize: bodyFont, lineHeight: Math.round(bodyFont * 1.6)},
                ]}>
                TabTrack garantiza la protección y confidencialidad de los datos
                de pago de sus usuarios a través de un modelo seguro y conforme
              ...
              <View style={styles.section}>
                <Text
                  style={[
                    ...
                    {fontSize: clamp(rf(16), 14, 20)},
                  ]}>
                  Procesamiento por terceros certificados
                </Text>
                <Text
                  style={[
                    styles.paragraph,
                    {
                      fontSize: bodyFont,
                      lineHeight: Math.round(bodyFont * 1.6),
                    },
                  ]}>
                  TabTrack no almacena información sensible de tarjetas ni datos
                  financieros de los usuarios. Todas las transacciones se
                  procesan mediante proveedores externos certificados bajo el
                  estándar PCI DSS, tales como OpenPay, Stripe, PayPal y Apple
                  Pay, quienes son responsables del manejo, cifrado y resguardo
                  de la información.
                </Text>
              </View>
              ...
              <View style={styles.section}>
                ...
                <Text
                  ...
                  TabTrack únicamente conserva identificadores y tokens cifrados
                  que permiten reconocer un método de pago autorizado, sin
                  acceder a los números completos de tarjeta, códigos de
                  seguridad u otros datos confidenciales.
                </Text>
              </View>
              ...
              <View style={styles.section}>
                <Text
                  ...
                  Canales y autenticación segura
                </Text>
                <Text
                  style={[
                    styles.paragraph,
                  ...
                  Todas las operaciones se realizan mediante canales HTTPS
                  seguros y sistemas de autenticación reforzada (como 3D Secure
                  o equivalentes) para prevenir accesos no autorizados o
                  fraudes.
                </Text>
              </View>
              ...
              <View style={styles.section}>
                <Text
                  ...
                  Responsabilidad y atención de incidencias
                </Text>
                <Text
                  style={[
                    styles.paragraph,
                  ...
                  Cualquier eventualidad, disputa o incidente relacionado con el
                  procesamiento de pagos será gestionado conforme a las
                  políticas y protocolos de los proveedores de pago utilizados.
                  TabTrack brindará acompañamiento al usuario para la correcta
                  canalización y seguimiento del caso.
                </Text>
              </View>
              ...
              <View style={styles.section}>
                ...
                <Text
                  ...
                  TabTrack cumple con la legislación mexicana en materia de
                  protección de datos personales y las disposiciones aplicables
                  a la seguridad de la información y medios de pago
                  electrónicos.
                </Text>
              </View>
            </View>
