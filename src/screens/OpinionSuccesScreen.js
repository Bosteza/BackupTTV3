      ...
      <LinearGradient
        ...
        <View style={styles.content}>
          ...
          <View style={styles.pointsWrap}>
            <Text style={styles.points} accessibilityLabel="Puntos obtenidos">
              24
            </Text>
          ...
          <Text style={styles.info}>
            Califica los lugares que visitas para seguir obteniendo Track Points
            y conseguir promociones en nuestros restaurantes afiliados
          </Text>
