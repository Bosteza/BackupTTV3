        ...
        <View style={styles.rightColumn}>
          <Text style={styles.instruction}>
            ...
            <Text style={styles.bold}>
              califica tu experiencia en el Japonéz
            </Text>{' '}
...
function makeStyles({
  ...
  return StyleSheet.create({
    ...
    logo: {
      width: Math.round(wp(20)),
      height: Math.round(rf(3.6)),
      resizeMode: 'contain',
    },
