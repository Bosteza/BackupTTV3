    ...
    <SafeAreaView style={[styles.safe, {paddingTop: insets.top}]}>
            ...
            <View style={styles.rowSmall}>
              ...
              <View style={styles.inputWrapSmall}>
                ...
                <TextInput
                  ...
                  value={cvv}
                  keyboardType="number-pad"
                  maxLength={cvvMax} // or 3 if you want fixed
                  onChangeText={t => {
                    const v = t.replace(/\D/g, '').slice(0, cvvMax); // or 3
                    setCvv(v);
                    if (v.length === cvvMax) {
                      cvvRef.current?.blur(); // remove focus
                      Keyboard.dismiss(); // close iOS keyboard
                    }
                  }}
                  placeholderTextColor="#96a0b8"
                />
      ...
      <Modal visible={successModalVisible} transparent animationType="fade">
        <View style={styles.autoModalBackdrop}>
          <View
            style={[styles.autoModalBox, {width: Math.min(320, winW - 40)}]}>
            ...
            <View style={styles.autoModalContent}>
              ...
              <Text style={styles.autoModalMsg}>
                Gracias — el pago se procesó correctamente.
              </Text>
            </View>
          </View>
        </View>
