...
const sampleNotices = [
  {
    ...
    body: 'Se realizará mantenimiento en la reja principal este viernes 15 de noviembre de 8:00 AM a 2:00 PM. Por favor usar entrada secundaria.',
    priority: 'urgente',
    color: '#2563EB',
  },
  {
    ...
    body: 'Se realizará la poda del pasto en las calles A, B y C el día sábado. Favor de no estacionar vehículos en estas áreas.',
    priority: 'normal',
    color: '#F97316',
  },
  {
    ...
    body: 'Se realiza menú para las fechas decembrinas solo bajo pedido, revisa las opciones en la cafetería y aparta con tiempo.',
    priority: 'normal',
    color: '#10B981',
  },
  {
    ...
    body: 'Ayúdanos contestando una breve encuesta sobre la limpieza y atención del personal. Tu opinión mejora el servicio.',
    priority: 'normal',
    color: '#6366F1',
  },
];
      ...
      <TouchableOpacity
        ...
        onPress={() => {
          if (navigation && navigation.navigate)
            navigation.navigate('AvisoDetalle', {id: item.id});
        }}
        style={[
          styles.card,
          urgent
        ...
        <View style={styles.cardInner}>
          <View style={[styles.iconWrap, {backgroundColor: item.color + '22'}]}>
            <Ionicons
              ...
              size={Math.round(iconBoxSize * 0.46)}
              color={item.color}
            />
          </View>

          <View
            style={[styles.cardContent, {paddingRight: contentPaddingRight}]}>
            ...
            <View style={styles.rowSpaceBetween}>
              <View style={styles.tagsRow}>
                <View style={styles.categoryPill}>
                  <Text style={[styles.categoryText, {fontSize: smallSize}]}>
                    {item.category}
                  </Text>
                </View>
              </View>

              <Text style={[styles.cardDate, {fontSize: smallSize}]}>
                {item.date}
              </Text>
            </View>
            ...
            <Text
              style={[styles.cardBody, {fontSize: bodySize}]}
              numberOfLines={4}>
              {item.body}
            </Text>
          </View>
  ...
  return (
    <SafeAreaView style={styles.safe}>
      ...
      <View style={[styles.listWrap, {paddingHorizontal: outerPad}]}>
        <Text style={[styles.sectionTitle, {fontSize: Math.round(rf(15))}]}>
          Avisos Recientes
        </Text>
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <Text style={{color: '#6b7280', paddingTop: 24}}>
